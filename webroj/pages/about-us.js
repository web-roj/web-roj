...
const About = () => {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
          try {
            ...
            const aboutUsBanners = bannersData.filter(banner => banner.category === "aboutus");
    ...
    const steps = [
        {
            id: 1,
            title: 'Research',
            description: 'We focus on understanding user intent, analyzing search trends, and identifying relevant keywords to inform content creation strategies.',
            icon: <FaSearch className="text-4xl text-pink-600" />
        },
        {
            id: 2,
            title: 'Customize',
            description: 'We tailor website elements, content, and technical aspects to optimize for search engine visibility and user experience.',
            icon: <FaCogs className="text-4xl text-pink-600" />
        },
        {
            id: 3,
            title: 'Targeting',
            description: 'We target specific demographics, audiences, and user behaviors to enhance visibility and drive relevant traffic to websites.',
            icon: <FaBullseye className="text-4xl text-pink-600" />
        },
        {
            id: 4,
            title: 'Result',
            description: 'We aim to achieve improved search engine rankings, increased organic traffic, and enhanced online visibility for websites.',
    ...
    return (
       <>
       <Head>
      <title>About Us - Webroj Software Company</title>
      <meta name="description" content="Learn more about Webroj, a leading IT company dedicated to delivering innovative software solutions that empower businesses and enhance customer experiences." />
       ...
       <div className="px-6 mt-6 text-center ">
        ...
        <div className="flex flex-col items-center justify-between px-6 py-1 md:flex-row md:px-6 lg:px-6 ">
           ...
           <div className="flex-1">
            ...
            <h2 className="mb-8 text-2xl font-bold text-gray-800 lg:text-4xl md:text-4xl">Helping Others <span className='text-[#fc005f]'>succeed</span></h2>
