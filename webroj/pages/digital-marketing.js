...
import { FaBullhorn, FaLightbulb, FaLongArrowAltRight } from 'react-icons/fa';
...
const About = () => {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
          try {
            ...
            const aboutUsBanners = bannersData.filter(banner => banner.category === "digital-marketing");
    ...
    const steps = [
        {
          ...
          description: 'We analyze the market trends and target audience to create an effective digital marketing strategy.',
          icon: <FaSearch className="text-4xl text-pink-600" />
        },
        {
          id: 2,
          title: 'Strategy Development',
          description: 'We develop tailored digital marketing strategies that align with business goals and audience needs.',
          icon: <FaLightbulb className="text-4xl text-pink-600" />
        },
        {
          id: 3,
          title: 'Campaign Execution',
          description: 'We execute marketing campaigns across digital platforms to drive traffic and boost engagement.',
          icon: <FaBullhorn className="text-4xl text-pink-600" />
        },
        {
          id: 4,
          title: 'Performance Tracking',
          description: 'We track key metrics and analyze data to ensure the campaigns are meeting objectives.',
    ...
    return (
        <div className="about">
           <Head>
      <title>Digital Marketing Services - Webroj Software Company</title>
      <meta name="description" content="Boost your online presence with our comprehensive digital marketing services. We offer SEO, social media marketing, content marketing, and more to help your business grow." />
  ...
  {banners.map(banner => (
    <div key={banner.id} className="relative w-full h-[150px] md:h-[200px]"> {/* Set a specific height for mobile */}
      ...
      <div className="absolute text-center text-white transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
        ...
        <span className="block mt-2 text-2xl font-bold sm:text-3xl lg:text-4xl whitespace-nowrap">Digital Marketing</span>
      </div>
    </div>
  ))}
</div>
  ...
  <h2 className="mb-8 text-2xl font-bold text-gray-800 lg:text-4xl md:text-4xl sm:text-3xl">
    Digital <span className='text-[#fc005f]'>Marketing</span>
  </h2>
