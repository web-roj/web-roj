...
import { FaBuilding, FaCertificate, FaLaptopCode, FaLongArrowAltRight, FaProjectDiagram } from 'react-icons/fa';
...
const About = () => {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
          try {
            ...
            const aboutUsBanners = bannersData.filter(banner => banner.category === "training-internship");
    ...
    const steps = [
        
        {
          ...
          description: 'Our training modules focus on developing both technical and soft skills to prepare you for real-world challenges.',
          icon: <FaLaptopCode className="text-4xl text-pink-600" />
        },
        {
          id: 2,
          title: 'Hands-On Projects',
          description: 'You will engage in live projects under expert mentorship to gain practical experience in your field of interest.',
          icon: <FaProjectDiagram className="text-4xl text-pink-600" />
        },
        {
          id: 3,
          title: 'Internship Placement',
          description: 'We help you find the right internship opportunity by matching you with organizations that align with your career goals.',
          icon: <FaBuilding className="text-4xl text-pink-600" />
        },
        {
          id: 4,
          title: 'Career Guidance',
          description: 'Upon completion, we provide certification and assist with career guidance to help you transition smoothly into the professional world.',
          icon: <FaCertificate className="text-4xl text-pink-600" />
        }
      ];
    ...
    return (
        <div className="about">
           <Head>
      <title>Training and Internship - Webroj Software Company</title>
      <meta name="description" content="Join our training and internship programs to enhance your skills and gain practical experience in a dynamic software development environment." />
    ...
    <div key={banner.id} className="relative w-full h-[150px] md:h-[200px]"> {/* Set a specific height for mobile */}
      ...
      <div className="absolute text-center text-white transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
        <Link href="/" className="block text-lg font-bold sm:text-2xl lg:text-2xl whitespace-nowrap">
          Home/Training & Internship
        </Link>
        <span className="block mt-2 text-2xl font-bold sm:text-3xl lg:text-4xl whitespace-nowrap">Training & Internship</span>
      </div>
    </div>
  ))}
</div>
  ...
  <h2 className="mb-8 text-2xl font-bold text-gray-800 lg:text-4xl md:text-4xl sm:text-3xl">
    Training & <span className='text-[#fc005f]'>Internship</span>
  </h2>
