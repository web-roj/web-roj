...
import { FaCertificate, FaChalkboardTeacher, FaLaptop, FaLongArrowAltRight, FaUserGraduate } from 'react-icons/fa';
...
const About = () => {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
          try {
            ...
            const aboutUsBanners = bannersData.filter(banner => banner.category === "education-elearning");
    ...
    const steps = [
        {
          ...
          description: 'Access a wide range of online courses tailored to enhance your skills and knowledge.',
          icon: <FaLaptop className="text-4xl text-pink-600" />
        },
        {
          id: 2,
          title: 'Interactive Learning',
          description: 'Engage in interactive learning experiences that make education more enjoyable and effective.',
          icon: <FaChalkboardTeacher className="text-4xl text-pink-600" />
        },
        {
          id: 3,
          title: 'Certification ',
          description: 'Enroll in certification programs to gain credentials recognized by industry leaders.',
          icon: <FaCertificate className="text-4xl text-pink-600" />
        },
        {
          id: 4,
          title: 'Tutoring Services',
          description: 'Get personalized tutoring services to help you excel in your studies and achieve your goals.',
    ...
    return (
        <div className="about">
          <Head>
      <title>Education and E-Learning - Webroj Software Company</title>
      <meta name="description" content="Discover our cutting-edge education and e-learning solutions that empower institutions and learners through innovative technology." />
    ...
    <div key={banner.id} className="relative w-full h-[150px] md:h-[200px]"> {/* Set a specific height for mobile */}
      ...
      <div className="absolute text-center text-white transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
        <Link href="/" className="block text-lg font-bold sm:text-2xl lg:text-2xl whitespace-nowrap">
          Home/Education & E-Learning
        </Link>
        <span className="block mt-2 text-2xl font-bold sm:text-3xl lg:text-4xl whitespace-nowrap">Education & E-Learning</span>
      </div>
    </div>
  ))}
</div>
  ...
  <h2 className="mb-8 text-2xl font-bold text-gray-800 lg:text-4xl md:text-4xl sm:text-3xl">
    Education & <span className='text-[#fc005f]'>E-Learning</span>
  </h2>
