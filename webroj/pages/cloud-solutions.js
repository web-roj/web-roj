...
import { FaClipboardList, FaCloud, FaCloudscale, FaCloudUploadAlt, FaLongArrowAltRight } from 'react-icons/fa';
...
const About = () => {
    ...
    useEffect(() => {
        const fetchBanners = async () => {
          try {
            ...
            const aboutUsBanners = bannersData.filter(banner => banner.category === "cloud-solutions");
    ...
    const steps = [
        {
          ...
          description: 'We evaluate business needs and recommend the best cloud strategy and solutions to fit your requirements.',
          icon: <FaCloud className="text-4xl text-pink-600" />
        },
        {
          id: 2,
          title: 'Migration Planning',
          description: 'We develop a detailed plan to seamlessly transition your existing infrastructure to the cloud environment.',
          icon: <FaClipboardList className="text-4xl text-pink-600" />
        },
        {
          id: 3,
          title: 'Cloud Deployment',
          description: 'We deploy your cloud infrastructure using secure and scalable cloud technologies tailored to your business.',
        ...
        
        {
          id: 4,
          title: 'Optimization ',
          description: 'We optimize cloud performance and scale resources to meet growing demands and ensure cost efficiency.',
          icon: <FaCloudscale className="text-4xl text-pink-600" />
        }
      ];
    ...
    return (
        <div className="about">
          <Head>
      <title>Cloud Solutions - Webroj Software Company</title>
      <meta name="description" content="Transform your business with our innovative cloud solutions. We provide scalable, secure, and reliable cloud services tailored to your needs." />
  ...
  {banners.map(banner => (
    <div key={banner.id} className="relative w-full h-[150px] md:h-[200px]"> {/* Set a specific height for mobile */}
      ...
      <div className="absolute text-center text-white transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
        ...
        <span className="block mt-2 text-2xl font-bold sm:text-3xl lg:text-4xl whitespace-nowrap">Cloud Solutions</span>
      </div>
    </div>
  ))}
</div>
  ...
  <h2 className="mb-8 text-2xl font-bold text-gray-800 lg:text-4xl md:text-4xl sm:text-3xl">
    Cloud <span className='text-[#fc005f]'>Solutions</span>
  </h2>
